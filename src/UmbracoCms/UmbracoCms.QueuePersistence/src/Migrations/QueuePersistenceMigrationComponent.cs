...
/// <summary>
/// Umbraco component that runs queue persistence database migrations on startup.
/// </summary>
...
public sealed class QueuePersistenceMigrationComponent(
    ...
    IRuntimeState runtimeState) : IAsyncComponent
{
    ...
    public async Task InitializeAsync(bool isRestarting, CancellationToken cancellationToken)
    {
        ...
        MigrationPlan migrationPlan = new("UmbracoComposeQueuePersistence");
        migrationPlan.From(string.Empty)
            .To<AddQueueTablesMigration>("compose-queue-tables-1.0.0");
