...
{
    public static JsonObject ToJsonObject(Umbraco.Compose.Cli.Models.Profile profile, bool includeSecrets)
    {
    ...
    public static JsonObject ToJsonObject(IDictionary<string, Umbraco.Compose.Cli.Models.Profile> profiles, bool includeSecrets)
    {
        var obj = new JsonObject();
