...
internal sealed class AgentInitCommand : BaseCommand
{
    ...
    [
        ("SKILL.md", "Umbraco.Compose.Cli.Resources.agents.skills.umbraco_compose.SKILL.md"),
        ("references/cli-reference.md", "Umbraco.Compose.Cli.Resources.agents.skills.umbraco_compose.references.cli-reference.md"),
        ("references/exit-codes.md", "Umbraco.Compose.Cli.Resources.agents.skills.umbraco_compose.references.exit-codes.md"),
        ("references/filtering-and-sorting.md", "Umbraco.Compose.Cli.Resources.agents.skills.umbraco_compose.references.filtering-and-sorting.md"),
        ("references/ingestion.md", "Umbraco.Compose.Cli.Resources.agents.skills.umbraco_compose.references.ingestion.md"),
        ("references/quick-reference.md", "Umbraco.Compose.Cli.Resources.agents.skills.umbraco_compose.references.quick-reference.md"),
        ("references/relay-connections.md", "Umbraco.Compose.Cli.Resources.agents.skills.umbraco_compose.references.relay-connections.md"),
        ("references/schema-mappings.md", "Umbraco.Compose.Cli.Resources.agents.skills.umbraco_compose.references.schema-mappings.md"),
    ];
